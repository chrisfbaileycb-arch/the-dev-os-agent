...
export default function Settings(p: SettingsProps) {
  ...
  function pick(m: CatalogModel) {
    ...
    p.setConnection({ ...base, mode: 'remote', model: m.id, inference: inferenceFor(m.id, base.inference) });
  }
